...
export const ADMIN_CELEBRITIES_FAIL = "ADMIN_CELEBRITIES_FAIL";
export const ADMIN_CELEBRITIES_SUCCESS = "ADMIN_CELEBRITIES_SUCCESS";
export const ADMIN_CELEBRITIES_REQUEST = "ADMIN_CELEBRITIES_REQUEST";
